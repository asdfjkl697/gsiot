...
void Player::initPlayer(unsigned long samplerate)
{
    int rc;
    ...
    /* Two channels (stereo) */
    snd_pcm_hw_params_set_channels(handle, params, 1); //jyc20170612 1 channels
...
void Player::play(char *buffer,int size)
{
    ...
    snd_pcm_close(handle); //jyc20170713 add
}
