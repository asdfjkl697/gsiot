...
#include "gsiot/GSIOTDevice.h" //jyc20170224 add
...
{
	defCtrlOprt_Null = 0,
	defCtrlOprt_CheckHeartbeat,			// ������
	defCtrlOprt_CheckDevTime,			// Уʱ

	defCtrlOprt_SendControl = 101,		// ����
	defCtrlOprt_DoPrePic	= 102,		// ���Ԥ��ͼ
	defCtrlOprt_DoRealPic	= 103,		// ���ʵʱͼ
	
	defCtrlOprt_DestroyObj = 901,		// ���ʵ��
};
