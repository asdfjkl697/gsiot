...
/*
运行码增加一个新编码:
s_RunCode 和 defCodeIndex_ 和 s_InitRunCode  各增加一项，并且枚举名后缀名保持一致。

使用IsRUNCODEEnable()判断功能是否开启
使用RUNCODE_Get()获取运行码值
*/
...
enum defCodeIndex_
{
	...
	// *** 特殊功能 ***
	defCodeIndex_TEST__Spec__, // 特殊功能分界线
...
#define defRunCodeVal_Disable		0		// 一般功能开启的value值
#define defRunCodeVal_Enable		1		// 一般功能开启的value值
#define defRunCodeVal_Spec_Enable	123456	// 特殊功能开启的value值
