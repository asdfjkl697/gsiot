...
#define defFilePath "E:\\iotcontrol"						// 程序安装路径

#define defFileName_App		"GSIOTController.exe"			// 应用程序名称
#define defFileName_AppNew	"GSIOTController_newupdate.exe"	// 应用程序更新名称
#define defFileName_Update	"gsupdate.exe"					// 升级程序名称
...
// 将wav头信息存入out_buffer缓存，参数in_buffer可为空
...
BOOL g_DeleteFileEx( const char *filename ); //20160526
