...
#include "APlayer.h" //jyc20170330 resume
...
GSIOTClient::GSIOTClient( IDeviceHandler *handler, const std::string &RunParam )
	...
	ipcamClient(NULL),xmppClient(NULL),timeCount(0),serverPingCount(0), m_handler(handler), m_running(false), 
...
void GSIOTClient::PreInit( const std::string &RunParam )
{
	...
	APlayer::Init();
	//this->m_TalkMgr.set_ITalkNotify( this ); //jyc20170330 trouble
...
GSAGCurState_ GSIOTClient::GetAllEventsState() const
{
	...
	//jyc20170330 resume but have trouble in run
...
void GSIOTClient::Connect()
{
	...
	PlayMgrCmd_ThreadCreate(); //jyc20170405 resume
	Playback_ThreadCreate(); //jyc20170405 resume
	DataProc_ThreadCreate(); 
	AlarmProc_ThreadCreate(); //jyc20170405 resume  camera alarm  //jyc20170222 no use
