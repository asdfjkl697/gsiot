...
static struRunCode s_RunCode[defCodeIndex_MAX_+1] = 
{
	...
	{ 19002, 490, 0, 0, 0, 0,0,0,0, "SYS_VChgRng_Temperature", StrNull, StrNull },	// �洢�仯���趨ֵ���¶ȱ仯��1000������ //860
	{ 19003, 1900, 0, 0, 0, 0,0,0,0, "SYS_VChgRng_Humidity", StrNull, StrNull },	// �洢�仯���趨ֵ��ʪ�ȱ仯��1000������ //3000
...
void s_InitRunCode(void)
{
	...
	//macCheckRunCode(SYS_VChgRng_PM25);
